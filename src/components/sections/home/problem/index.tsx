...
export default function Problem() {
  ...
  return (
    <section ref={ref} className="py-12 lg:py-21.5 bg-primary lg:min-h-[180vh]">
      <div className="container-wrapper lg:mb-56">
        ...
        <div className="grid gap-6">
          {problems.map((problem, index) => (
            <Card
              key={index}
              className="backdrop-blur-lg bg-muted/35 rounded-xl"
            >
        ...
        <motion.div style={{ y: y1 }} className="grid lg:grid-cols-4 hidden">
        ...
        <motion.div style={{ y: y2 }} className="grid lg:grid-cols-4 hidden">
        ...
        <motion.div style={{ y: y3 }} className="grid lg:grid-cols-4 hidden">
        ...
        <motion.div style={{ y: y4 }} className="grid lg:grid-cols-4 hidden">
          <Card className="backdrop-blur-lg bg-muted/35 rounded-xl col-start-4">
            <CardContent className="grid gap-40">
              <div className="h-12 w-12 border rounded-lg"></div>
              <CardDescription className="text-white">
        ...
        <motion.div style={{ y: y5 }} className="grid lg:grid-cols-4 hidden">
        ...
        <motion.div style={{ y: y6 }} className="grid lg:grid-cols-4 hidden">
